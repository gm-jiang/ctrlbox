...
void RF315_IN(void) 
{
  	...
  	if (rf315_en==0)
    {
      	...
      	if (((short_k*22)<head_k) && (head_k<(short_k*38)))
        {
            ...
            else if((rf315_buf[0][0]==rf315_buf[1][0]) && (rf315_buf[0][1]==rf315_buf[1][1]) && (rf315_buf[0][2]==rf315_buf[1][2]))	//?????????????
            {	       
...
void RF330_IN(void) 
{
  	...
  	if (rf330_en==0)
    {
      	...
      	if (((short_k*22)<head_k) && (head_k<(short_k*38)))
        {
            ...
            else if((rf330_buf[0][0]==rf330_buf[1][0]) && (rf330_buf[0][1]==rf330_buf[1][1]) && (rf330_buf[0][2]==rf330_buf[1][2]))	//?????????????
            {	       
                for(i=0;i<4;i++)  			//??2262?1527
                {
                    for(u=0;u<4;u++) 
...
void RF433_IN(void) 
{
  	...
  	if (rf433_en==0)
    {
      	...
      	if (((short_k*22)<head_k) && (head_k<(short_k*38)))
        {
            ...
            else if((rf433_buf[0][0]==rf433_buf[1][0]) && (rf433_buf[0][1]==rf433_buf[1][1]) && (rf433_buf[0][2]==rf433_buf[1][2]))	//?????????????
            {	       
                for(i=0;i<4;i++)  			//??2262?1527
                {
                    for(u=0;u<4;u++) 
