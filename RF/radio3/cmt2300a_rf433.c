...
#include "cmt2300a_hal_rf433.h" //ÐÂÔö
/*! ********************************************************
* @name    CMT2300A_SoftReset
* @desc    Soft reset.
* *********************************************************/
void CMT2300A_SoftReset_RF433(void)
{
    CMT2300A_WriteReg_RF433(0x7F, 0xFF);
}
...
*          CMT2300A_STA_CAL
* *********************************************************/
u8 CMT2300A_GetChipStatus_RF433(void)
{
    return  CMT2300A_ReadReg_RF433(CMT2300A_CUS_MODE_STA) & CMT2300A_MASK_CHIP_MODE_STA;
}
...
* *********************************************************/
BOOL CMT2300A_AutoSwitchStatus_RF433(u8 nGoCmd)
{
#ifdef ENABLE_AUTO_SWITCH_CHIP_STATUS_RF433
    u32 nBegTick = CMT2300A_GetTickCount_RF433();
    u8  nWaitStatus;
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_MODE_CTL, nGoCmd);
    
    while(CMT2300A_GetTickCount_RF433()-nBegTick < 10)
    {
        CMT2300A_DelayUs_RF433(100);
        
        if(nWaitStatus==CMT2300A_GetChipStatus_RF433())
            return TRUE;
        
        if(CMT2300A_GO_TX==nGoCmd) {
            CMT2300A_DelayUs_RF433(100);
            
            if(CMT2300A_MASK_TX_DONE_FLG & CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT_CLR1))
                return TRUE;
        }
        ...
        if(CMT2300A_GO_RX==nGoCmd) {
            ...
            if(CMT2300A_MASK_PKT_OK_FLG & CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT_FLAG))
                return TRUE;
        }
    }
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoSleep_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_SLEEP);
}
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoStby_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_STBY);
}
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoTFS_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_TFS);
}
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoRFS_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_RFS);
}
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoTx_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_TX);
}
...
* @return  TRUE or FALSE
* *********************************************************/
BOOL CMT2300A_GoRx_RF433(void)
{
    return CMT2300A_AutoSwitchStatus_RF433(CMT2300A_GO_RX);
}
...
* *********************************************************/
void CMT2300A_ConfigGpio_RF433(u8 nGpioSel)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_IO_SEL, nGpioSel);
}
...
* *********************************************************/
void CMT2300A_ConfigInterrupt_RF433(u8 nInt1Sel, u8 nInt2Sel)
{
    nInt1Sel &= CMT2300A_MASK_INT1_SEL;
    nInt1Sel |= (~CMT2300A_MASK_INT1_SEL) & CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT1_CTL);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT1_CTL, nInt1Sel);

    nInt2Sel &= CMT2300A_MASK_INT2_SEL;
    nInt2Sel |= (~CMT2300A_MASK_INT2_SEL) & CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT2_CTL);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT2_CTL, nInt2Sel);
}
...
* *********************************************************/
void CMT2300A_SetInterruptPolar_RF433(BOOL bActiveHigh)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT1_CTL);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT1_CTL, tmp);
}
...
* *********************************************************/
void CMT2300A_SetFifoThreshold_RF433(u8 nFifoThreshold)
{ 
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_PKT29);
    
    tmp &= ~CMT2300A_MASK_FIFO_TH;
    tmp |= nFifoThreshold & CMT2300A_MASK_FIFO_TH;
    
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_PKT29, tmp);
}
...
* *********************************************************/
void CMT2300A_EnableAntennaSwitch_RF433(u8 nMode)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT1_CTL);
...
* *********************************************************/
void CMT2300A_EnableInterrupt_RF433(u8 nEnable)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT_EN, nEnable);
}
...
* *********************************************************/
void CMT2300A_EnableRxFifoAutoClear_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FIFO_CTL, tmp);
}
...
* *********************************************************/
void CMT2300A_EnableFifoMerge_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
...
* *********************************************************/
void CMT2300A_EnableReadFifo_RF433(void)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
...
* *********************************************************/
void CMT2300A_EnableWriteFifo_RF433(void)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
    tmp |= CMT2300A_MASK_SPI_FIFO_RD_WR_SEL;
    tmp |= CMT2300A_MASK_FIFO_RX_TX_SEL;
...
* *********************************************************/
void CMT2300A_RestoreFifo_RF433(void)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_RESTORE);
}
...
* *********************************************************/
u8 CMT2300A_ClearTxFifo_RF433(void)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_FLAG);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_CLR_TX);
    return tmp;
}
...
*            CMT2300A_MASK_TX_FIFO_TH_FLG
* *********************************************************/
u8 CMT2300A_ClearRxFifo_RF433(void)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_FLAG);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_CLR_RX);
    return tmp;
}
...
* *********************************************************/
u8 CMT2300A_ClearInterruptFlags_RF433(void)
{
    u8 nFlag1, nFlag2;
    u8 nClr1 = 0;
    u8 nClr2 = 0;
    ...
    nIntPolar = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT1_CTL);
    nIntPolar = (nIntPolar & CMT2300A_MASK_INT_POLAR) ?1 :0;

    nFlag1 = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT_FLAG);
    nFlag2 = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT_CLR1);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT_CLR1, nClr1);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT_CLR2, nClr2);
...
* *********************************************************/
void CMT2300A_ConfigTxDin_RF433(u8 nDinSel)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
...
* *********************************************************/
void CMT2300A_EnableTxDin_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FIFO_CTL);
...
* *********************************************************/
void CMT2300A_EnableTxDinInvert_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT2_CTL);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_INT2_CTL, tmp);
}
...
* *********************************************************/
BOOL CMT2300A_IsExist_RF433(void)
{
    u8 back, dat;

    back = CMT2300A_ReadReg_RF433(CMT2300A_CUS_PKT17);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_PKT17, 0xAA);

    dat = CMT2300A_ReadReg_RF433(CMT2300A_CUS_PKT17);
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_PKT17, back);
...
* @return  RSSI code
* *********************************************************/
u8 CMT2300A_GetRssiCode_RF433(void)
{
    return CMT2300A_ReadReg_RF433(CMT2300A_CUS_RSSI_CODE);
}
...
* @return  dBm
* *********************************************************/
int CMT2300A_GetRssiDBm_RF433(void)
{
    return (int)CMT2300A_ReadReg_RF433(CMT2300A_CUS_RSSI_DBM) - 128;
}
...
* *********************************************************/
void CMT2300A_SetFrequencyChannel_RF433(u8 nChann)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FREQ_CHNL, nChann);
}
...
* *********************************************************/
void CMT2300A_SetFrequencyStep_RF433(u8 nOffset)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FREQ_OFS, nOffset);
}
...
* @param   nLength
* *********************************************************/
void CMT2300A_SetPayloadLength_RF433(u16 nLength)
{ 
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_PKT14);
    
    tmp &= ~CMT2300A_MASK_PAYLOAD_LENG_10_8;
    tmp |= (nLength >> 4) & CMT2300A_MASK_PAYLOAD_LENG_10_8;
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_PKT14, tmp);
    
    tmp = nLength & CMT2300A_MASK_PAYLOAD_LENG_7_0;
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_PKT15, tmp);
}
...
*          bEnable(FALSE): Disable it
* *********************************************************/
void CMT2300A_EnableLfosc_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_SYS2);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_SYS2, tmp);
}
...
* *********************************************************/
void CMT2300A_EnableLfoscOutput_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_INT2_CTL);
...
*          bEnable(FALSE): Disable it(default)
* *********************************************************/
void CMT2300A_EnableAfc_RF433(BOOL bEnable)
{
    u8 tmp = CMT2300A_ReadReg_RF433(CMT2300A_CUS_FSK5);
    ...
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FSK5, tmp);
}
...
* *********************************************************/
void CMT2300A_SetAfcOvfTh_RF433(u8 afcOvfTh)
{
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_FSK4, afcOvfTh);
}
...
* *********************************************************/
void CMT2300A_Init_RF433(void)
{
    u8 tmp;

    CMT2300A_SoftReset_RF433();
    CMT2300A_DelayMs_RF433(10);
    
    CMT2300A_GoStby_RF433();

    tmp  = CMT2300A_ReadReg_RF433(CMT2300A_CUS_MODE_STA);
    tmp |= CMT2300A_MASK_CFG_RETAIN;         /* Enable CFG_RETAIN */
    tmp &= ~CMT2300A_MASK_RSTN_IN_EN;        /* Disable RSTN_IN */
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_MODE_STA, tmp);

    tmp  = CMT2300A_ReadReg_RF433(CMT2300A_CUS_EN_CTL);
    tmp |= CMT2300A_MASK_LOCKING_EN;         /* Enable LOCKING_EN */
    CMT2300A_WriteReg_RF433(CMT2300A_CUS_EN_CTL, tmp);
    
    CMT2300A_EnableLfosc_RF433(FALSE);             /* Diable LFOSC */
...
* *********************************************************/
BOOL CMT2300A_ConfigRegBank_RF433(u8 base_addr, const u8 bank[], u8 len)
{
    u8 i;
    for(i=0; i<len; i++)
        CMT2300A_WriteReg_RF433(i+base_addr, bank[i]);
