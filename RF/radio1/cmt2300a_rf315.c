...
#include "cmt2300a_hal_rf315.h" //ÐÂÔö
/*! ********************************************************
...
{
    CMT2300A_WriteReg_RF315(0x7F, 0xFF);
}
...
{
    return  CMT2300A_ReadReg_RF315(CMT2300A_CUS_MODE_STA) & CMT2300A_MASK_CHIP_MODE_STA;
}
...
{
#ifdef ENABLE_AUTO_SWITCH_CHIP_STATUS_RF315
    u32 nBegTick = CMT2300A_GetTickCount_RF315();
    u8  nWaitStatus;
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_MODE_CTL, nGoCmd);
    
    while(CMT2300A_GetTickCount_RF315()-nBegTick < 10)
    {
        CMT2300A_DelayUs_RF315(100);
        
        if(nWaitStatus==CMT2300A_GetChipStatus_RF315())
            return TRUE;
        
        if(CMT2300A_GO_TX==nGoCmd) {
            CMT2300A_DelayUs_RF315(100);
            
            if(CMT2300A_MASK_TX_DONE_FLG & CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT_CLR1))
                return TRUE;
        }
        ...
        if(CMT2300A_GO_RX==nGoCmd) {
            ...
            if(CMT2300A_MASK_PKT_OK_FLG & CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT_FLAG))
                return TRUE;
        }
    }
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_SLEEP);
}
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_STBY);
}
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_TFS);
}
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_RFS);
}
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_TX);
}
...
{
    return CMT2300A_AutoSwitchStatus_RF315(CMT2300A_GO_RX);
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_IO_SEL, nGpioSel);
}
...
void CMT2300A_ConfigInterrupt_RF315(u8 nInt1Sel, u8 nInt2Sel)
{
    ...
    nInt1Sel |= (~CMT2300A_MASK_INT1_SEL) & CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT1_CTL);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT1_CTL, nInt1Sel);

    nInt2Sel &= CMT2300A_MASK_INT2_SEL;
    nInt2Sel |= (~CMT2300A_MASK_INT2_SEL) & CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT2_CTL);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT2_CTL, nInt2Sel);
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT1_CTL);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT1_CTL, tmp);
}
...
{ 
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_PKT29);
    
    tmp &= ~CMT2300A_MASK_FIFO_TH;
    tmp |= nFifoThreshold & CMT2300A_MASK_FIFO_TH;
    
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_PKT29, tmp);
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT_EN, nEnable);
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_FIFO_CTL);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FIFO_CTL, tmp);
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_RESTORE);
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_FIFO_FLAG);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_CLR_TX);
    return tmp;
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_FIFO_FLAG);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FIFO_CLR, CMT2300A_MASK_FIFO_CLR_RX);
    return tmp;
}
...
u8 CMT2300A_ClearInterruptFlags_RF315(void)
{
    ...
    nIntPolar = CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT1_CTL);
    nIntPolar = (nIntPolar & CMT2300A_MASK_INT_POLAR) ?1 :0;

    nFlag1 = CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT_FLAG);
    nFlag2 = CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT_CLR1);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT_CLR1, nClr1);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT_CLR2, nClr2);
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_INT2_CTL);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_INT2_CTL, tmp);
}
...
BOOL CMT2300A_IsExist_RF315(void)
{
    ...
    back = CMT2300A_ReadReg_RF315(CMT2300A_CUS_PKT17);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_PKT17, 0xAA);

    dat = CMT2300A_ReadReg_RF315(CMT2300A_CUS_PKT17);
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_PKT17, back);
...
{
    return CMT2300A_ReadReg_RF315(CMT2300A_CUS_RSSI_CODE);
}
...
{
    return (int)CMT2300A_ReadReg_RF315(CMT2300A_CUS_RSSI_DBM) - 128;
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FREQ_CHNL, nChann);
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FREQ_OFS, nOffset);
}
...
{ 
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_PKT14);
    
    tmp &= ~CMT2300A_MASK_PAYLOAD_LENG_10_8;
    tmp |= (nLength >> 4) & CMT2300A_MASK_PAYLOAD_LENG_10_8;
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_PKT14, tmp);
    
    tmp = nLength & CMT2300A_MASK_PAYLOAD_LENG_7_0;
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_PKT15, tmp);
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_SYS2);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_SYS2, tmp);
}
...
{
    u8 tmp = CMT2300A_ReadReg_RF315(CMT2300A_CUS_FSK5);
    ...
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FSK5, tmp);
}
...
{
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_FSK4, afcOvfTh);
}
...
void CMT2300A_Init_RF315(void)
{
    ...
    CMT2300A_DelayMs_RF315(10);
    
    CMT2300A_GoStby_RF315();

    tmp  = CMT2300A_ReadReg_RF315(CMT2300A_CUS_MODE_STA);
    tmp |= CMT2300A_MASK_CFG_RETAIN;         /* Enable CFG_RETAIN */
    tmp &= ~CMT2300A_MASK_RSTN_IN_EN;        /* Disable RSTN_IN */
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_MODE_STA, tmp);

    tmp  = CMT2300A_ReadReg_RF315(CMT2300A_CUS_EN_CTL);
    tmp |= CMT2300A_MASK_LOCKING_EN;         /* Enable LOCKING_EN */
    CMT2300A_WriteReg_RF315(CMT2300A_CUS_EN_CTL, tmp);
    
    CMT2300A_EnableLfosc_RF315(FALSE);             /* Diable LFOSC */
...
BOOL CMT2300A_ConfigRegBank_RF315(u8 base_addr, const u8 bank[], u8 len)
{
    u8 i;
    for(i=0; i<len; i++)
        CMT2300A_WriteReg_RF315(i+base_addr, bank[i]);
