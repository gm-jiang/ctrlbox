...
{
//	 CMT2300A_SetGpio1In_RF330();
//    CMT2300A_SetGpio2In_RF330();
    CMT2300A_SetGpio3In_RF330();
	//CMT2300A_GPIO_RF330();
    cmt_spi3_init_RF330();
}
...
{
    cmt_spi3_read_fifo_RF330(buf, len);
}
...
{
    cmt_spi3_write_fifo_RF330(buf, len);
}
