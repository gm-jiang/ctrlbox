...
void RF_Config_TX(void)
{
    ...
    //    CMT2300A_EnableTxDin(TRUE);//ʹ��GPIO����Ϊ����
    //		CMT2300A_ConfigTxDin(CMT2300A_TX_DIN_SEL_GPIO1);//ѡ��GPIO1��Ϊ���η����
    //	  CMT2300A_EnableTxDinInvert(FALSE);//���䲨��ʹ��Ĭ��״̬����ȡ����

    //    /* Disable low frequency OSC calibration */
    //    CMT2300A_EnableLfosc(FALSE);
    //
    //    /* Use a single 64-byte FIFO for either Tx or Rx */
    //    CMT2300A_EnableFifoMerge(TRUE); //�ϲ�FIFO
    //
    //    CMT2300A_SetFifoThreshold(FIFO_TH); // ������ֵ
    //
    ...
    CMT2300A_EnableLfosc(FALSE);
    CMT2300A_ConfigGpio(CMT2300A_GPIO3_SEL_DOUT);    //����GPIO123�Ĺ���
    CMT2300A_EnableTxDin(TRUE);                      //����GPIOΪ���ʹ��
    CMT2300A_ConfigTxDin(CMT2300A_TX_DIN_SEL_GPIO3); //ѡ��GPIO1Ϊ�����λ
